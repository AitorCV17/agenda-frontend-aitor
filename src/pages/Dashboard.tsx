      ...
      <div className="w-full max-w-6xl p-10 bg-white dark:bg-gray-800 shadow-2xl rounded-2xl">
        ...
        {data ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Eventos */}
            <motion.div 
              className="p-6 bg-gradient-to-r from-azure-400 to-azure-600 dark:from-azure-700 dark:to-azure-900 text-white rounded-xl shadow-lg hover:shadow-2xl transform transition duration-300 hover:scale-105 flex flex-col items-center"
            ...
            {/* Notas */}
            <motion.div 
              className="p-6 bg-gradient-to-r from-green-400 to-green-600 dark:from-green-700 dark:to-green-900 text-white rounded-xl shadow-lg hover:shadow-2xl transform transition duration-300 hover:scale-105 flex flex-col items-center"
              whileHover={{ scale: 1.05 }}
            >
            ...
            {/* Listas de tareas */}
            <motion.div 
              className="p-6 bg-gradient-to-r from-purple-400 to-purple-600 dark:from-purple-700 dark:to-purple-900 text-white rounded-xl shadow-lg hover:shadow-2xl transform transition duration-300 hover:scale-105 flex flex-col items-center"
              whileHover={{ scale: 1.05 }}
            >
            ...
            {/* Tareas */}
            <motion.div 
              className="p-6 bg-gradient-to-r from-yellow-400 to-yellow-600 dark:from-yellow-700 dark:to-yellow-900 text-white rounded-xl shadow-lg hover:shadow-2xl transform transition duration-300 hover:scale-105 flex flex-col items-center"
              whileHover={{ scale: 1.05 }}
            >
